...
transf_set_parameters <- function(
  fb,
  transf_method = "asinh",
  transf_params = 5,
  overwrite = FALSE,
...
#' @title update_transf_from_panel
#'
#' @description ...
#'
#' @param fb a flowBunch.
...
update_transf_from_panel <- function(
  fb,
  channels
) {
  assertClass(fb, "flowBunch")
